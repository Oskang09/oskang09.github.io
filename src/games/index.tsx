...
const Game = (props: IGameProps) => {
  ...
  useEffect(() => {
    ...
    (async function () {
      ...
      await init(document.getElementById('game') as HTMLCanvasElement);
      document.getElementById('gameLoader')?.remove();
      setCanvasStyle({ ...canvasStyle, display: 'block' });
    })();
  }, []);
  ...
  return (
    <div>
      ...
      <svg
        id="gameLoader"
        aria-hidden="true"
        className="size-20 animate-spin	fill-blue-600 text-center text-gray-200 dark:text-gray-600"
        viewBox="0 0 100 101"
        fill="none"
